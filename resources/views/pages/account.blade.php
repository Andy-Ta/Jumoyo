                    ...
                    <div class="tab-pane fade" id="b">
                        ...
                        <div class="col-xs-12 rowlist">
                            ...
                            <div class="col-md-8">
                                <div class="list">
                                    <div class="heading">
                                        <h4><a href="/service/{{$value->service_id}}">{{$value->service_name}}</a></h4>
                                        <div class="starts">
                                                    <span class="stars">
                                    ...
                                    <div class="heading">
                                        <div class="favourite">
                                            ...
                                            @endif
                                            <span><a href="/service/{{$value->service_id}}"><button type="button"
                                        ...
                                        <a href="#" data-toggle="modal"
                                           ...
                                           name="changeAccImage">
                                            <img class="imgbooking"
                                                 src="{{URL::asset(session('image'))}}" alt="Account Img">
                                        </a>
                                    @else
                                        <a href="#" data-toggle="modal"
                                        data-target="#changeAccImgModal" id="changeAccImage"
                                        name="changeAccImage">
                                            <img class="imgbooking"
                                                 src="{{URL::asset('/img/review-icon.png')}}" alt="Account Img">
                                        </a>
                                    @endif
